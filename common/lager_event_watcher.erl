...
%% set ./erl_expect -sname ejabberd@sdb-ali-hangzhou-ejabberd3 -setcookie 'LTBEXKHWOCIRRSEUNSYS' common/lager_event_watcher.erl threshold|interval|marks_len|reboot_after N
%% e.g.
...
case Args of
    ["start"] ->
        ...
        MarksLen = application:get_env(lager, event_watcher_marks_len, 3),
